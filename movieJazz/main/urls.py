...
urlpatterns = [
    ...
    path(r'theaters/<int:theater_id>/movies', views.theaterMovies, name = 'theaterMovies'),
    path(r'theaters/<int:theater_id>/movies/<int:movie_id>/tickets', views.tickets, name = 'tickets'),
    path(r'theaters/<int:theater_id>/movies/<int:movie_id>/tickets/<int:ticket_id>', views.addCart, name = 'addCart' ),
